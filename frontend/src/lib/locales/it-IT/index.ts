...
export const itIT = {
  ...
  exams: {
    title: "Esami di prova",
    subtitle: "Genera esami di prova dalle conoscenze di \"{notebook}\" e ricevi una valutazione con IA.",
    newExam: "Nuovo esame",
    emptyState: "Ancora nessun esame di prova. Generane uno dalle conoscenze di questo taccuino.",
    backToNotebook: "Torna al taccuino",
    backToList: "Torna agli esami",
    startExam: "Inizia",
    questionCount: "{count} domande",
    pointsTotal: "{points} punti",
    pointsBadge: "{points} pt",
    deleteConfirm: "Eliminare questo esame e tutte le sue consegne?",
    generateTitle: "Genera esame di prova",
    generateDescription: "Le domande vengono create dalle fonti e dalle note di questo taccuino. Un esame di riferimento facoltativo viene usato solo come modello di stile.",
    titleLabel: "Titolo",
    titlePlaceholder: "Lascia vuoto per generarlo automaticamente",
    ...
    language: "Lingua",
    languagePlaceholder: "es. Tedesco (facoltativo)",
    referenceExam: "Esame di riferimento (solo stile)",
    referenceNone: "Nessuno",
    untitledSource: "Fonte senza titolo",
    model: "Modello",
    modelDefault: "Modello predefinito (dalle Impostazioni)",
    instructions: "Istruzioni aggiuntive",
    instructionsPlaceholder: "Indicazioni facoltative per il generatore dell'esame",
    generate: "Genera",
    submitForGrading: "Invia per la valutazione",
    answerPlaceholder: "Scrivi la tua risposta…",
    resultTitle: "Il tuo risultato",
    feedback: "Feedback",
    modelAnswer: "Risposta modello",
    generateSuccess: "Esame generato correttamente",
    updateSuccess: "Esame aggiornato correttamente",
    deleteSuccess: "Esame eliminato correttamente",
  },
  study: {
    title: "Studio",
  },
  quiz: {
    ...
    generateDesc: "Crea un quiz a scelta multipla dal contenuto di questo notebook.",
    generating: "Generazione in corso...",
    numQuestions: "Numero di domande",
    noQuizzesYet: "Ancora nessun quiz",
    noQuizzesYetDesc: "Genera un quiz per testare la tua comprensione di questo notebook.",
    ...
    correct: "Corretto!",
    incorrect: "Errato",
    score: "Hai risposto correttamente a {correct} domande su {total}",
    retake: "Rifai il quiz",
    questionProgress: "Domanda {current} di {total}",
    deleteQuiz: "Elimina quiz",
    deleteQuizConfirm: "Sei sicuro di voler eliminare questo quiz? Questa azione non può essere annullata.",
    quizDeleted: "Quiz eliminato",
    generationStarted: "Quiz generato",
    generationStartedDesc: "Il tuo quiz è pronto.",
    failedToGenerate: "Generazione del quiz non riuscita",
    failedToDelete: "Eliminazione del quiz non riuscita",
  },
  flashcards: {
    title: "Flashcard",
    generate: "Genera flashcard",
    generateDesc: "Crea un set di flashcard dal contenuto di questo notebook.",
    generating: "Generazione in corso...",
    numCards: "Numero di carte",
    noDecksYet: "Ancora nessun mazzo di flashcard",
    noDecksYetDesc: "Genera un mazzo per iniziare a ripassare i concetti chiave di questo notebook.",
    cardsCount: "{count} carte",
    study: "Studia",
    shuffle: "Mescola",
    flip: "Clicca sulla carta per girarla",
    knowIt: "La so",
    stillLearning: "Ancora da imparare",
    restart: "Studia di nuovo",
    cardProgress: "Carta {current} di {total}",
    studyComplete: "Sapevi {known} carte su {total}",
    deleteDeck: "Elimina mazzo di flashcard",
    deleteDeckConfirm: "Sei sicuro di voler eliminare questo mazzo di flashcard? Questa azione non può essere annullata.",
    deckDeleted: "Mazzo di flashcard eliminato",
    generationStarted: "Flashcard generate",
    generationStartedDesc: "Il tuo mazzo di flashcard è pronto per lo studio.",
    failedToGenerate: "Generazione delle flashcard non riuscita",
    failedToDelete: "Eliminazione del mazzo di flashcard non riuscita",
  },
