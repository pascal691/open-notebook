...
export const jaJP = {
  ...
  exams: {
    title: "模擬試験",
    subtitle: "「{notebook}」の知識から模擬試験を生成し、AIによる採点を受けられます。",
    newExam: "新しい試験",
    emptyState: "まだ模擬試験はありません。このノートブックの知識から作成してください。",
    backToNotebook: "ノートブックに戻る",
    backToList: "試験一覧に戻る",
    startExam: "開始",
    questionCount: "{count} 問",
    pointsTotal: "{points} 点",
    pointsBadge: "{points} 点",
    deleteConfirm: "この試験とすべての提出を削除しますか？",
    generateTitle: "模擬試験を生成",
    generateDescription: "問題はこのノートブックのソースとノートから作成されます。任意の参照試験はスタイルのテンプレートとしてのみ使用されます。",
    titleLabel: "タイトル",
    titlePlaceholder: "空欄の場合は自動生成されます",
    numQuestions: "問題数",
    difficulty: "難易度",
    difficultyOptions: {
      easy: "やさしい",
    ...
    language: "言語",
    languagePlaceholder: "例: ドイツ語（任意）",
    referenceExam: "参照試験（スタイルのみ）",
    referenceNone: "なし",
    untitledSource: "無題のソース",
    model: "モデル",
    modelDefault: "既定のモデル（設定から）",
    instructions: "追加の指示",
    instructionsPlaceholder: "試験生成のための任意の指示",
    generate: "生成",
    submitForGrading: "採点に提出",
    answerPlaceholder: "回答を入力…",
    resultTitle: "あなたの結果",
    feedback: "フィードバック",
    modelAnswer: "模範解答",
    generateSuccess: "試験を生成しました",
    updateSuccess: "試験を更新しました",
    deleteSuccess: "試験を削除しました",
  },
  study: {
    title: "学習",
  },
  quiz: {
    title: "クイズ",
    generate: "クイズを生成",
    generateDesc: "このノートブックの内容から選択式クイズを作成します。",
    generating: "生成中...",
    numQuestions: "問題数",
    noQuizzesYet: "クイズはまだありません",
    noQuizzesYetDesc: "クイズを生成して、このノートブックの理解度をテストしましょう。",
    ...
    correct: "正解！",
    incorrect: "不正解",
    score: "{total} 問中 {correct} 問正解しました",
    retake: "クイズをやり直す",
    questionProgress: "{total} 問中 {current} 問目",
    deleteQuiz: "クイズを削除",
    deleteQuizConfirm: "このクイズを削除してもよろしいですか？この操作は元に戻せません。",
    quizDeleted: "クイズを削除しました",
    generationStarted: "クイズを生成しました",
    generationStartedDesc: "クイズの準備ができました。",
    failedToGenerate: "クイズの生成に失敗しました",
    failedToDelete: "クイズの削除に失敗しました",
  },
  flashcards: {
    title: "フラッシュカード",
    generate: "フラッシュカードを生成",
    generateDesc: "このノートブックの内容からフラッシュカードのセットを作成します。",
    generating: "生成中...",
    numCards: "カード数",
    noDecksYet: "フラッシュカードのデッキはまだありません",
    noDecksYetDesc: "デッキを生成して、このノートブックの重要な概念の復習を始めましょう。",
    cardsCount: "{count} 枚",
    study: "学習",
    shuffle: "シャッフル",
    flip: "カードをクリックして裏返す",
    ...
    stillLearning: "まだ学習中",
    restart: "もう一度学習する",
    cardProgress: "{total} 枚中 {current} 枚目",
    studyComplete: "{total} 枚中 {known} 枚を覚えました",
    deleteDeck: "フラッシュカードのデッキを削除",
    deleteDeckConfirm: "このフラッシュカードのデッキを削除してもよろしいですか？この操作は元に戻せません。",
    deckDeleted: "フラッシュカードのデッキを削除しました",
    generationStarted: "フラッシュカードを生成しました",
    generationStartedDesc: "フラッシュカードのデッキの準備ができました。",
    failedToGenerate: "フラッシュカードの生成に失敗しました",
    failedToDelete: "フラッシュカードのデッキの削除に失敗しました",
  },
