export const zhTW = {
  ...
  quiz: {
    title: "測驗",
    generate: "產生測驗",
    generateDesc: "根據此筆記本的內容建立一個選擇題測驗。",
    generating: "產生中...",
    numQuestions: "問題數量",
    noQuizzesYet: "尚無測驗",
    noQuizzesYetDesc: "產生一個測驗來檢驗你對此筆記本的理解。",
    ...
    correct: "回答正確！",
    incorrect: "回答錯誤",
    score: "你答對了 {total} 題中的 {correct} 題",
    retake: "重新測驗",
    questionProgress: "第 {current} 題，共 {total} 題",
    deleteQuiz: "刪除測驗",
    deleteQuizConfirm: "確定要刪除此測驗嗎？此操作無法復原。",
    quizDeleted: "測驗已刪除",
    generationStarted: "測驗已產生",
    generationStartedDesc: "你的測驗已準備就緒。",
    failedToGenerate: "產生測驗失敗",
    failedToDelete: "刪除測驗失敗",
  },
  flashcards: {
    title: "字卡",
    generate: "產生字卡",
    generateDesc: "根據此筆記本的內容建立一組字卡。",
    generating: "產生中...",
    numCards: "卡片數量",
    noDecksYet: "尚無字卡組",
    noDecksYetDesc: "產生一組字卡，開始複習此筆記本的關鍵概念。",
    ...
    studyComplete: "共 {total} 張卡片，你掌握了 {known} 張",
    deleteDeck: "刪除字卡組",
    deleteDeckConfirm: "確定要刪除此字卡組嗎？此操作無法復原。",
    deckDeleted: "字卡組已刪除",
    generationStarted: "字卡已產生",
    generationStartedDesc: "你的字卡組已準備好開始學習。",
    failedToGenerate: "產生字卡失敗",
    failedToDelete: "刪除字卡組失敗",
  },
  setupBanner: {
    encryptionRequired: "未設定加密金鑰",
  ...
  exams: {
    title: "模擬考試",
    subtitle: "根據「{notebook}」中的知識產生模擬考試，並取得 AI 評分回饋。",
    newExam: "新增考試",
    emptyState: "尚無模擬考試。根據此筆記本的知識產生一個。",
    backToNotebook: "返回筆記本",
    backToList: "返回考試列表",
    startExam: "開始",
    questionCount: "{count} 道題",
    pointsTotal: "{points} 分",
    pointsBadge: "{points} 分",
    deleteConfirm: "刪除此考試及其所有作答？",
    generateTitle: "產生模擬考試",
    generateDescription: "題目根據此筆記本的來源與筆記產生。選用的參考試卷僅作為樣式範本。",
    titleLabel: "標題",
    titlePlaceholder: "留空則自動產生",
    numQuestions: "題目數量",
    difficulty: "難度",
    difficultyOptions: {
      easy: "簡單",
    ...
    language: "語言",
    languagePlaceholder: "例如：德語（選填）",
    referenceExam: "參考試卷（僅樣式）",
    referenceNone: "無",
    untitledSource: "未命名來源",
    model: "模型",
    modelDefault: "預設模型（來自設定）",
    instructions: "其他說明",
    instructionsPlaceholder: "給考試產生器的選用提示",
    generate: "產生",
    submitForGrading: "提交評分",
    answerPlaceholder: "輸入你的答案…",
    resultTitle: "你的成績",
    feedback: "回饋",
    modelAnswer: "參考答案",
    generateSuccess: "考試產生成功",
    updateSuccess: "考試更新成功",
    deleteSuccess: "考試刪除成功",
  },
}
