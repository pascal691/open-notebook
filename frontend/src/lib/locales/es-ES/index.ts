...
export const esES = {
  ...
  exams: {
    ...
    subtitle: "Genera exámenes de práctica a partir del conocimiento de \"{notebook}\" y recibe una evaluación con IA.",
    newExam: "Nuevo examen",
    emptyState: "Aún no hay exámenes de práctica. Genera uno a partir del conocimiento de este cuaderno.",
    backToNotebook: "Volver al cuaderno",
    backToList: "Volver a los exámenes",
    startExam: "Empezar",
    questionCount: "{count} preguntas",
    pointsTotal: "{points} puntos",
    pointsBadge: "{points} pts",
    deleteConfirm: "¿Eliminar este examen y todas sus entregas?",
    generateTitle: "Generar examen de práctica",
    generateDescription: "Las preguntas se crean a partir de las fuentes y notas de este cuaderno. Un examen de referencia opcional se usa solo como plantilla de estilo.",
    titleLabel: "Título",
    titlePlaceholder: "Déjalo en blanco para generarlo automáticamente",
    ...
    language: "Idioma",
    languagePlaceholder: "p. ej. Alemán (opcional)",
    referenceExam: "Examen de referencia (solo estilo)",
    referenceNone: "Ninguno",
    untitledSource: "Fuente sin título",
    model: "Modelo",
    modelDefault: "Modelo predeterminado (de Ajustes)",
    instructions: "Instrucciones adicionales",
    instructionsPlaceholder: "Indicaciones opcionales para el generador del examen",
    generate: "Generar",
    submitForGrading: "Enviar para evaluación",
    answerPlaceholder: "Escribe tu respuesta…",
    resultTitle: "Tu resultado",
    feedback: "Comentarios",
    modelAnswer: "Respuesta modelo",
    generateSuccess: "Examen generado correctamente",
    updateSuccess: "Examen actualizado correctamente",
    deleteSuccess: "Examen eliminado correctamente",
  },
  study: {
    title: "Estudio",
  },
  quiz: {
    ...
    generateDesc: "Crea un cuestionario de opción múltiple a partir del contenido de este cuaderno.",
    generating: "Generando...",
    numQuestions: "Número de preguntas",
    noQuizzesYet: "Todavía no hay cuestionarios",
    noQuizzesYetDesc: "Genera un cuestionario para poner a prueba tu comprensión de este cuaderno.",
    ...
    deleteQuizConfirm: "¿Seguro que deseas eliminar este cuestionario? Esta acción no se puede deshacer.",
    quizDeleted: "Cuestionario eliminado",
    generationStarted: "Cuestionario generado",
    generationStartedDesc: "Tu cuestionario está listo para responder.",
    failedToGenerate: "No se pudo generar el cuestionario",
    failedToDelete: "No se pudo eliminar el cuestionario",
  },
  flashcards: {
    title: "Tarjetas de estudio",
    generate: "Generar tarjetas de estudio",
    generateDesc: "Crea un conjunto de tarjetas de estudio a partir del contenido de este cuaderno.",
    generating: "Generando...",
    numCards: "Número de tarjetas",
    noDecksYet: "Todavía no hay mazos de tarjetas",
    noDecksYetDesc: "Genera un mazo para empezar a repasar los conceptos clave de este cuaderno.",
    cardsCount: "{count} tarjetas",
    study: "Estudiar",
    shuffle: "Mezclar",
    flip: "Haz clic en la tarjeta para voltearla",
    knowIt: "Lo sé",
    stillLearning: "Todavía aprendiendo",
    restart: "Volver a estudiar",
    cardProgress: "Tarjeta {current} de {total}",
    studyComplete: "Sabías {known} de {total} tarjetas",
    deleteDeck: "Eliminar mazo de tarjetas",
    deleteDeckConfirm: "¿Seguro que deseas eliminar este mazo de tarjetas? Esta acción no se puede deshacer.",
    deckDeleted: "Mazo de tarjetas eliminado",
    generationStarted: "Tarjetas generadas",
    generationStartedDesc: "Tu mazo de tarjetas está listo para estudiar.",
    failedToGenerate: "No se pudieron generar las tarjetas",
    failedToDelete: "No se pudo eliminar el mazo de tarjetas",
  },
