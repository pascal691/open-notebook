export const ptBR = {
  ...
  quiz: {
    title: "Quiz",
    generate: "Gerar Quiz",
    generateDesc: "Crie um quiz de múltipla escolha a partir do conteúdo deste notebook.",
    generating: "Gerando...",
    numQuestions: "Número de perguntas",
    noQuizzesYet: "Nenhum quiz ainda",
    noQuizzesYetDesc: "Gere um quiz para testar seu entendimento deste notebook.",
    ...
    deleteQuizConfirm: "Tem certeza de que deseja excluir este quiz? Esta ação não pode ser desfeita.",
    quizDeleted: "Quiz excluído",
    generationStarted: "Quiz gerado",
    generationStartedDesc: "Seu quiz está pronto para ser respondido.",
    failedToGenerate: "Falha ao gerar quiz",
    failedToDelete: "Falha ao excluir quiz",
  },
  flashcards: {
    title: "Cartões de Estudo",
    generate: "Gerar Cartões de Estudo",
    generateDesc: "Crie um conjunto de cartões de estudo a partir do conteúdo deste notebook.",
    generating: "Gerando...",
    numCards: "Número de cartões",
    noDecksYet: "Nenhum baralho de cartões ainda",
    noDecksYetDesc: "Gere um baralho para começar a revisar os conceitos-chave deste notebook.",
    cardsCount: "{count} cartões",
    study: "Estudar",
    shuffle: "Embaralhar",
    flip: "Clique no cartão para virá-lo",
    knowIt: "Já sei",
    stillLearning: "Ainda aprendendo",
    restart: "Estudar novamente",
    cardProgress: "Cartão {current} de {total}",
    studyComplete: "Você sabia {known} de {total} cartões",
    deleteDeck: "Excluir baralho de cartões",
    deleteDeckConfirm: "Tem certeza de que deseja excluir este baralho de cartões? Esta ação não pode ser desfeita.",
    deckDeleted: "Baralho de cartões excluído",
    generationStarted: "Cartões gerados",
    generationStartedDesc: "Seu baralho de cartões está pronto para estudo.",
    failedToGenerate: "Falha ao gerar cartões",
    failedToDelete: "Falha ao excluir baralho de cartões",
  },
  setupBanner: {
    encryptionRequired: "Chave de criptografia não configurada",
  ...
  exams: {
    title: "Provas de prática",
    subtitle: "Gere provas de prática a partir do conhecimento em \"{notebook}\" e receba avaliação com IA.",
    newExam: "Nova prova",
    emptyState: "Ainda não há provas de prática. Gere uma a partir do conhecimento deste caderno.",
    backToNotebook: "Voltar ao caderno",
    backToList: "Voltar às provas",
    startExam: "Iniciar",
    questionCount: "{count} questões",
    pointsTotal: "{points} pontos",
    pointsBadge: "{points} pts",
    deleteConfirm: "Excluir esta prova e todas as suas submissões?",
    generateTitle: "Gerar prova de prática",
    generateDescription: "As questões são criadas a partir das fontes e notas deste caderno. Uma prova de referência opcional é usada apenas como modelo de estilo.",
    titleLabel: "Título",
    titlePlaceholder: "Deixe em branco para gerar automaticamente",
    ...
    language: "Idioma",
    languagePlaceholder: "ex. Alemão (opcional)",
    referenceExam: "Prova de referência (apenas estilo)",
    referenceNone: "Nenhuma",
    untitledSource: "Fonte sem título",
    model: "Modelo",
    modelDefault: "Modelo padrão (das Configurações)",
    instructions: "Instruções adicionais",
    instructionsPlaceholder: "Orientações opcionais para o gerador da prova",
    generate: "Gerar",
    submitForGrading: "Enviar para avaliação",
    answerPlaceholder: "Digite sua resposta…",
    resultTitle: "Seu resultado",
    feedback: "Feedback",
    modelAnswer: "Resposta modelo",
    generateSuccess: "Prova gerada com sucesso",
    updateSuccess: "Prova atualizada com sucesso",
    deleteSuccess: "Prova excluída com sucesso",
  },
}
