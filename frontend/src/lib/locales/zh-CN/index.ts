export const zhCN = {
  ...
  quiz: {
    title: "测验",
    generate: "生成测验",
    generateDesc: "根据此笔记本的内容创建一个选择题测验。",
    generating: "生成中...",
    numQuestions: "问题数量",
    noQuizzesYet: "暂无测验",
    noQuizzesYetDesc: "生成一个测验来检验你对此笔记本的理解。",
    ...
    deleteQuiz: "删除测验",
    deleteQuizConfirm: "确定要删除此测验吗？此操作无法撤销。",
    quizDeleted: "测验已删除",
    generationStarted: "测验已生成",
    generationStartedDesc: "你的测验已准备就绪。",
    failedToGenerate: "生成测验失败",
    failedToDelete: "删除测验失败",
  },
  flashcards: {
    title: "闪卡",
    generate: "生成闪卡",
    generateDesc: "根据此笔记本的内容创建一组闪卡。",
    generating: "生成中...",
    numCards: "卡片数量",
    noDecksYet: "暂无闪卡组",
    noDecksYetDesc: "生成一组闪卡，开始复习此笔记本的关键概念。",
    ...
    studyComplete: "共 {total} 张卡片，你掌握了 {known} 张",
    deleteDeck: "删除闪卡组",
    deleteDeckConfirm: "确定要删除此闪卡组吗？此操作无法撤销。",
    deckDeleted: "闪卡组已删除",
    generationStarted: "闪卡已生成",
    generationStartedDesc: "你的闪卡组已准备好开始学习。",
    failedToGenerate: "生成闪卡失败",
    failedToDelete: "删除闪卡组失败",
  },
  setupBanner: {
    encryptionRequired: "未配置加密密钥",
  ...
  exams: {
    title: "模拟考试",
    subtitle: "根据“{notebook}”中的知识生成模拟考试，并获得 AI 评分反馈。",
    newExam: "新建考试",
    emptyState: "暂无模拟考试。根据此笔记本的知识生成一个。",
    ...
    deleteConfirm: "删除此考试及其所有作答？",
    generateTitle: "生成模拟考试",
    generateDescription: "题目根据此笔记本的来源和笔记生成。可选的参考试卷仅用作样式模板。",
    titleLabel: "标题",
    ...
    language: "语言",
    languagePlaceholder: "例如：德语（可选）",
    referenceExam: "参考试卷（仅样式）",
    referenceNone: "无",
    untitledSource: "未命名来源",
    model: "模型",
    modelDefault: "默认模型（来自设置）",
    instructions: "附加说明",
    instructionsPlaceholder: "给考试生成器的可选提示",
    generate: "生成",
    ...
    feedback: "反馈",
    modelAnswer: "参考答案",
    generateSuccess: "考试生成成功",
    updateSuccess: "考试更新成功",
    deleteSuccess: "考试删除成功",
  },
}
