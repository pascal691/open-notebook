export const enUS = {
  ...
  quiz: {
    ...
    generateDesc: "Create a multiple-choice quiz from this notebook's content.",
    generating: "Generating...",
    numQuestions: "Number of questions",
    noQuizzesYet: "No quizzes yet",
    noQuizzesYetDesc: "Generate a quiz to test your understanding of this notebook.",
    ...
    generationStarted: "Quiz generated",
    generationStartedDesc: "Your quiz is ready to take.",
    failedToGenerate: "Failed to generate quiz",
    failedToDelete: "Failed to delete quiz",
  },
  flashcards: {
    title: "Flashcards",
    generate: "Generate Flashcards",
    generateDesc: "Create a set of flashcards from this notebook's content.",
    generating: "Generating...",
    numCards: "Number of cards",
    noDecksYet: "No flashcard decks yet",
    noDecksYetDesc: "Generate a deck to start reviewing this notebook's key concepts.",
    ...
    studyComplete: "You knew {known} out of {total} cards",
    deleteDeck: "Delete flashcard deck",
    deleteDeckConfirm: "Are you sure you want to delete this flashcard deck? This action cannot be undone.",
    deckDeleted: "Flashcard deck deleted",
    generationStarted: "Flashcards generated",
    generationStartedDesc: "Your flashcard deck is ready to study.",
    failedToGenerate: "Failed to generate flashcards",
    failedToDelete: "Failed to delete flashcard deck",
  },
  setupBanner: {
    encryptionRequired: "Encryption key not configured",
  ...
  exams: {
    ...
    subtitle: "Generate practice exams from the knowledge in \"{notebook}\" and get AI-graded feedback.",
    newExam: "New exam",
    emptyState: "No practice exams yet. Generate one from this notebook's knowledge.",
    ...
    deleteConfirm: "Delete this exam and all of its submissions?",
    generateTitle: "Generate practice exam",
    generateDescription: "Questions are created from this notebook's sources and notes. An optional reference exam is used only as a style template.",
    titleLabel: "Title",
    ...
    language: "Language",
    languagePlaceholder: "e.g. German (optional)",
    ...
    generateSuccess: "Exam generated successfully",
