export const bnIN = {
  ...
  quiz: {
    ...
    generateDesc: "এই নোটবুকের বিষয়বস্তু থেকে একটি বহু-বিকল্প কুইজ তৈরি করুন।",
    generating: "তৈরি হচ্ছে...",
    numQuestions: "প্রশ্নের সংখ্যা",
    noQuizzesYet: "এখনও কোনো কুইজ নেই",
    noQuizzesYetDesc: "এই নোটবুক সম্পর্কে আপনার বোঝাপড়া যাচাই করতে একটি কুইজ তৈরি করুন।",
    ...
    correct: "সঠিক!",
    incorrect: "ভুল",
    score: "আপনি {total}টির মধ্যে {correct}টি সঠিক উত্তর দিয়েছেন",
    retake: "আবার দিন",
    questionProgress: "প্রশ্ন {current} এর {total}",
    deleteQuiz: "কুইজ মুছুন",
    deleteQuizConfirm: "আপনি কি নিশ্চিত যে এই কুইজটি মুছতে চান? এই কাজটি ফিরিয়ে আনা যাবে না।",
    quizDeleted: "কুইজ মুছে ফেলা হয়েছে",
    generationStarted: "কুইজ তৈরি হয়েছে",
    generationStartedDesc: "আপনার কুইজ দেওয়ার জন্য প্রস্তুত।",
    failedToGenerate: "কুইজ তৈরি করতে ব্যর্থ হয়েছে",
    failedToDelete: "কুইজ মুছতে ব্যর্থ হয়েছে",
  },
  flashcards: {
    title: "ফ্ল্যাশকার্ড",
    generate: "ফ্ল্যাশকার্ড তৈরি করুন",
    generateDesc: "এই নোটবুকের বিষয়বস্তু থেকে ফ্ল্যাশকার্ডের একটি সেট তৈরি করুন।",
    generating: "তৈরি হচ্ছে...",
    numCards: "কার্ডের সংখ্যা",
    noDecksYet: "এখনও কোনো ফ্ল্যাশকার্ড ডেক নেই",
    noDecksYetDesc: "এই নোটবুকের মূল ধারণাগুলি পর্যালোচনা শুরু করতে একটি ডেক তৈরি করুন।",
    cardsCount: "{count}টি কার্ড",
    study: "অধ্যয়ন করুন",
    shuffle: "শাফল করুন",
    flip: "কার্ডটি উল্টাতে ক্লিক করুন",
    knowIt: "জানি",
    stillLearning: "এখনও শিখছি",
    restart: "আবার অধ্যয়ন করুন",
    cardProgress: "কার্ড {current} এর {total}",
    studyComplete: "আপনি {total}টির মধ্যে {known}টি কার্ড জানতেন",
    deleteDeck: "ফ্ল্যাশকার্ড ডেক মুছুন",
    deleteDeckConfirm: "আপনি কি নিশ্চিত যে এই ফ্ল্যাশকার্ড ডেকটি মুছতে চান? এই কাজটি ফিরিয়ে আনা যাবে না।",
    deckDeleted: "ফ্ল্যাশকার্ড ডেক মুছে ফেলা হয়েছে",
    generationStarted: "ফ্ল্যাশকার্ড তৈরি হয়েছে",
    generationStartedDesc: "আপনার ফ্ল্যাশকার্ড ডেক অধ্যয়নের জন্য প্রস্তুত।",
    failedToGenerate: "ফ্ল্যাশকার্ড তৈরি করতে ব্যর্থ হয়েছে",
    failedToDelete: "ফ্ল্যাশকার্ড ডেক মুছতে ব্যর্থ হয়েছে",
  },
  setupBanner: {
    encryptionRequired: "এনক্রিপশন কী কনফিগার করা হয়নি",
  ...
  exams: {
    title: "অনুশীলন পরীক্ষা",
    subtitle: "\"{notebook}\"-এর জ্ঞান থেকে অনুশীলন পরীক্ষা তৈরি করুন এবং AI-চালিত মূল্যায়ন পান।",
    newExam: "নতুন পরীক্ষা",
    emptyState: "এখনও কোনো অনুশীলন পরীক্ষা নেই। এই নোটবুকের জ্ঞান থেকে একটি তৈরি করুন।",
    backToNotebook: "নোটবুকে ফিরে যান",
    backToList: "পরীক্ষায় ফিরে যান",
    startExam: "শুরু করুন",
    questionCount: "{count}টি প্রশ্ন",
    pointsTotal: "{points} পয়েন্ট",
    pointsBadge: "{points} পয়েন্ট",
    deleteConfirm: "এই পরীক্ষা এবং এর সমস্ত জমা মুছে ফেলবেন?",
    generateTitle: "অনুশীলন পরীক্ষা তৈরি করুন",
    generateDescription: "প্রশ্নগুলি এই নোটবুকের উৎস ও নোট থেকে তৈরি হয়। একটি ঐচ্ছিক রেফারেন্স পরীক্ষা শুধুমাত্র স্টাইল টেমপ্লেট হিসেবে ব্যবহৃত হয়।",
    titleLabel: "শিরোনাম",
    titlePlaceholder: "স্বয়ংক্রিয়ভাবে তৈরি করতে ফাঁকা রাখুন",
    numQuestions: "প্রশ্নের সংখ্যা",
    difficulty: "কঠিনতা",
    difficultyOptions: {
      easy: "সহজ",
    ...
    language: "ভাষা",
    languagePlaceholder: "যেমন জার্মান (ঐচ্ছিক)",
    referenceExam: "রেফারেন্স পরীক্ষা (শুধু স্টাইল)",
    referenceNone: "কোনোটি নয়",
    untitledSource: "শিরোনামহীন উৎস",
    model: "মডেল",
    modelDefault: "ডিফল্ট মডেল (সেটিংস থেকে)",
    instructions: "অতিরিক্ত নির্দেশনা",
    instructionsPlaceholder: "পরীক্ষা জেনারেটরের জন্য ঐচ্ছিক নির্দেশনা",
    generate: "তৈরি করুন",
    ...
    generateSuccess: "পরীক্ষা সফলভাবে তৈরি হয়েছে",
    updateSuccess: "পরীক্ষা সফলভাবে আপডেট হয়েছে",
    deleteSuccess: "পরীক্ষা সফলভাবে মুছে ফেলা হয়েছে",
  },
}
