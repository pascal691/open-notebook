...
export const frFR = {
  ...
  exams: {
    ...
    subtitle: "Générez des examens blancs à partir des connaissances de « {notebook} » et obtenez une évaluation par IA.",
    newExam: "Nouvel examen",
    emptyState: "Aucun examen blanc pour l'instant. Générez-en un à partir des connaissances de ce carnet.",
    ...
    deleteConfirm: "Supprimer cet examen et toutes ses soumissions ?",
    generateTitle: "Générer un examen blanc",
    generateDescription: "Les questions sont créées à partir des sources et notes de ce carnet. Un examen de référence facultatif sert uniquement de modèle de style.",
    titleLabel: "Titre",
    titlePlaceholder: "Laisser vide pour générer automatiquement",
    ...
    language: "Langue",
    languagePlaceholder: "ex. Allemand (facultatif)",
    referenceExam: "Examen de référence (style uniquement)",
    referenceNone: "Aucun",
    untitledSource: "Source sans titre",
    model: "Modèle",
    modelDefault: "Modèle par défaut (des Paramètres)",
    instructions: "Instructions supplémentaires",
    instructionsPlaceholder: "Consignes facultatives pour le générateur d'examen",
    generate: "Générer",
    ...
    generateSuccess: "Examen généré avec succès",
  ...
  quiz: {
    ...
    generateDesc: "Créez un quiz à choix multiples à partir du contenu de ce notebook.",
    generating: "Génération...",
    numQuestions: "Nombre de questions",
    noQuizzesYet: "Aucun quiz pour le moment",
    noQuizzesYetDesc: "Générez un quiz pour tester votre compréhension de ce notebook.",
    ...
    deleteQuizConfirm: "Voulez-vous vraiment supprimer ce quiz ? Cette action est irréversible.",
    quizDeleted: "Quiz supprimé",
    generationStarted: "Quiz généré",
    generationStartedDesc: "Votre quiz est prêt à être passé.",
    failedToGenerate: "Échec de la génération du quiz",
    failedToDelete: "Échec de la suppression du quiz",
  },
  flashcards: {
    title: "Cartes mémoire",
    generate: "Générer des cartes mémoire",
    generateDesc: "Créez un jeu de cartes mémoire à partir du contenu de ce notebook.",
    generating: "Génération...",
    numCards: "Nombre de cartes",
    noDecksYet: "Aucun jeu de cartes pour le moment",
    noDecksYetDesc: "Générez un jeu de cartes pour commencer à réviser les concepts clés de ce notebook.",
    ...
    restart: "Recommencer l'étude",
    cardProgress: "Carte {current} sur {total}",
    studyComplete: "Vous connaissiez {known} cartes sur {total}",
    deleteDeck: "Supprimer le jeu de cartes",
    deleteDeckConfirm: "Voulez-vous vraiment supprimer ce jeu de cartes ? Cette action est irréversible.",
    deckDeleted: "Jeu de cartes supprimé",
    generationStarted: "Cartes mémoire générées",
    generationStartedDesc: "Votre jeu de cartes est prêt à être étudié.",
    failedToGenerate: "Échec de la génération des cartes mémoire",
    failedToDelete: "Échec de la suppression du jeu de cartes",
  },
