...
export const ruRU = {
  ...
  exams: {
    ...
    subtitle: "Создавайте пробные экзамены на основе знаний из «{notebook}» и получайте оценку с помощью ИИ.",
    newExam: "Новый экзамен",
    emptyState: "Пробных экзаменов пока нет. Создайте один на основе знаний этого блокнота.",
    backToNotebook: "Назад к блокноту",
    backToList: "Назад к экзаменам",
    startExam: "Начать",
    questionCount: "Вопросов: {count}",
    pointsTotal: "{points} баллов",
    pointsBadge: "{points} б.",
    deleteConfirm: "Удалить этот экзамен и все его отправленные ответы?",
    generateTitle: "Создать пробный экзамен",
    generateDescription: "Вопросы создаются на основе источников и заметок этого блокнота. Необязательный образец экзамена используется только как шаблон оформления.",
    titleLabel: "Название",
    titlePlaceholder: "Оставьте пустым для автоматического создания",
    ...
    language: "Язык",
    languagePlaceholder: "напр. Немецкий (необязательно)",
    referenceExam: "Образец экзамена (только оформление)",
    referenceNone: "Нет",
    untitledSource: "Источник без названия",
    model: "Модель",
    modelDefault: "Модель по умолчанию (из настроек)",
    instructions: "Дополнительные указания",
    instructionsPlaceholder: "Необязательные указания для генератора экзамена",
    generate: "Создать",
    ...
    generateSuccess: "Экзамен успешно создан",
    updateSuccess: "Экзамен успешно обновлён",
    deleteSuccess: "Экзамен успешно удалён",
  },
  study: {
    title: "Обучение",
  },
  quiz: {
    title: "Викторина",
    generate: "Создать викторину",
    generateDesc: "Создайте викторину с вариантами ответов на основе содержимого этого блокнота.",
    generating: "Создание...",
    numQuestions: "Количество вопросов",
    noQuizzesYet: "Пока нет викторин",
    noQuizzesYetDesc: "Создайте викторину, чтобы проверить понимание материала этого блокнота.",
    ...
    correct: "Верно!",
    incorrect: "Неверно",
    score: "Вы ответили правильно на {correct} из {total}",
    retake: "Пройти заново",
    questionProgress: "Вопрос {current} из {total}",
    deleteQuiz: "Удалить викторину",
    deleteQuizConfirm: "Вы уверены, что хотите удалить эту викторину? Это действие нельзя отменить.",
    quizDeleted: "Викторина удалена",
    generationStarted: "Викторина создана",
    generationStartedDesc: "Ваша викторина готова к прохождению.",
    failedToGenerate: "Не удалось создать викторину",
    failedToDelete: "Не удалось удалить викторину",
  },
  flashcards: {
    title: "Карточки",
    generate: "Создать карточки",
    generateDesc: "Создайте набор карточек на основе содержимого этого блокнота.",
    generating: "Создание...",
    numCards: "Количество карточек",
    noDecksYet: "Пока нет колод карточек",
    noDecksYetDesc: "Создайте колоду, чтобы начать повторять ключевые понятия этого блокнота.",
    cardsCount: "{count} карточек",
    study: "Учить",
    shuffle: "Перемешать",
    flip: "Нажмите на карточку, чтобы перевернуть её",
    knowIt: "Знаю",
    stillLearning: "Ещё учу",
    restart: "Повторить заново",
    cardProgress: "Карточка {current} из {total}",
    studyComplete: "Вы знаете {known} из {total} карточек",
    deleteDeck: "Удалить колоду карточек",
    deleteDeckConfirm: "Вы уверены, что хотите удалить эту колоду карточек? Это действие нельзя отменить.",
    deckDeleted: "Колода карточек удалена",
    generationStarted: "Карточки созданы",
    generationStartedDesc: "Ваша колода карточек готова к изучению.",
    failedToGenerate: "Не удалось создать карточки",
    failedToDelete: "Не удалось удалить колоду карточек",
  },
